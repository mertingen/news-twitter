...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'http.service' => 'getHttp_ServiceService',
            'http_client' => 'getHttpClientService',
            'http_kernel' => 'getHttpKernelService',
            'kernel' => 'getKernelService',
            'kernel.class_cache.cache_warmer' => 'getKernel_ClassCache_CacheWarmerService',
            'keyword.service' => 'getKeyword_ServiceService',
            ...
            'redis.service' => 'getRedis_ServiceService',
            ...
            'security.user_provider' => 'getSecurity_UserProviderService',
            ...
            'session.service' => 'getSession_ServiceService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('r6jNi6+sPA', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0GkxQq5v-y', 0, 'dZflSlxWrYaWVQ-qL6V+PN', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'news_keyword', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_cc85a6e90cbfc7ebb0a709ef6e61d08c1ec8d754655414db66b6192b85aade40');
    ...
    /**
     * Gets the 'http.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\HttpService A AppBundle\Service\HttpService instance
     */
    protected function getHttp_ServiceService()
    {
        return $this->services['http.service'] = new \AppBundle\Service\HttpService($this->get('http_client'));
    }
    ...
    {
        return $this->services['http_client'] = new \GuzzleHttp\Client(array('base_uri' => 'http://localhost:3000/v1', 'timeout' => 30, 'connect_timeout' => 5));
    }
    ...
    /**
     * Gets the 'keyword.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getKeyword_ServiceService()
    {
        return $this->services['keyword.service'] = new \AppBundle\Service\KeywordService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    /**
     * Gets the 'redis.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\RedisService A AppBundle\Service\RedisService instance
     */
    protected function getRedis_ServiceService()
    {
        return $this->services['redis.service'] = new \AppBundle\Service\RedisService();
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j->addHandler(new \Symfony\Component\Security\Http\Logout\CookieClearingLogoutHandler(array('PHPSESSID' => array('path' => '/', 'domain' => NULL))));
    ...
    /**
     * Gets the 'security.user_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\UserProvider A AppBundle\Security\UserProvider instance
     */
    protected function getSecurity_UserProviderService()
    {
        return $this->services['security.user_provider'] = new \AppBundle\Security\UserProvider($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    /**
     * Gets the 'session.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\SessionService A AppBundle\Service\SessionService instance
     */
    protected function getSession_ServiceService()
    {
        return $this->services['session.service'] = new \AppBundle\Service\SessionService($this->get('session'));
    }
    ...
    /**
     * Gets the 'user.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\UserService A AppBundle\Service\UserService instance
     */
    protected function getUser_ServiceService()
    {
        return $this->services['user.service'] = new \AppBundle\Service\UserService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YaQOYrdMlB', 0, 'dZflSlxWrYaWVQ-qL6V+PN', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user_provider'), new \Symfony\Component\Security\Core\User\UserChecker(), 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5932f90ea7a803.28579564')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'callback_url' => 'http://localhost:5050/checkLoginTwitter',
            'consumer_key' => 'GR7gUwTSc21nrj2GjO1aRwkxW',
            'consumer_secret_key' => 'v3UIX6bBHXc8siHMtzW22bbCesO7LlfAAwGOLxVYUG0PrCLW0J',
            'api_host' => 'http://localhost:3000/v1',
            'cache_provider' => 'array_cache',
            'redis_cache_host' => 'localhost',
            'redis_cache_port' => 6379,
            'redis_cache_keyspace' => 'tweet',
