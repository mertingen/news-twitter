...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('+AFeYEvLmp', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Lt6JsBE+ZS', 0, 'zYC8GUcXH8SWoylZ3vp2bX', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'news_twitter', 'user' => 'root', 'password' => 'sem123', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_00f2df614f1643f38d2e8fe8f8f9283d96c0b164006d4843e2bdfc72a5bab16a');
    ...
    {
        return $this->services['http_client'] = new \GuzzleHttp\Client(array('base_uri' => 'http://localhost:3000/v2', 'timeout' => 30, 'connect_timeout' => 5));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f4961a3398e51cd772219633daf2c6c7245c7ebd');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HJ+JlYNVuX', 0, 'zYC8GUcXH8SWoylZ3vp2bX', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'news_twitter',
            'database_user' => 'root',
            'database_password' => 'sem123',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'f4961a3398e51cd772219633daf2c6c7245c7ebd',
            ...
            'api_host' => 'http://localhost:3000/v2',
            ...
            'kernel.secret' => 'f4961a3398e51cd772219633daf2c6c7245c7ebd',
